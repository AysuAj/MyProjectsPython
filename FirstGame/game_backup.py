...
car_police = pygame.image.load('imagens/car_police.png')
car_police1 = pygame.image.load('imagens/car_police_2.png')
car_police2 = pygame.image.load('imagens/car_police_3.png')
